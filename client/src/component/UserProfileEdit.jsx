...
const UserProfileEdit = ({close}) => {
    ...
    return (
        <section className='fixed top-0 left-0 bottom-0 right-0 bg-neutral-900 bg-opacity-55 p-4 flex items-center justify-center'>
            <div className='bg-white max-w-sm w-full rounded p-4 flex flex-col items-center justify-center'>
                ...
                <form onSubmit={handleSubmit}>
                    <label htmlFor="uploadProfile">
                        <div className='border border-blue-200 hover:border-blue-700 hover:bg-blue-300
                          px-3 py-1 rounded-full mt-4 text-sm cursor-pointer'>
                          {
